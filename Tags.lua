...
GBB.badTagsLoc = langSplit( {
  enGB = "2s 3s 5s 2v2 2vs2 3v3 3v3s 5v5 5vs5 boost recruit apply social roster raids twitch stream hardcore times team speaking speaker core cores",
  deDE = "fc",
...
GBB.dungeonTagsLoc = {
  enGB = langSplit( {
    ...
    [ "GY" ]     = "gy graveyard smg smgy",
    [ "LIB" ]    = "lib library smlib sml",
    [ "ARMS" ]   = "armory armoury arms smarm sma herod",
    [ "CATH" ]   = "cath cathedral smc smcath",
    [ "RFD" ]    = "rfd downs",
    [ "ULDA" ]   = "uld ulda uldaman",
    [ "ZF" ]     = "zf zul farrak zul'farrak zulfarrak zulfarak zulf",
    [ "MARA" ]   = "mara maraudon princessrun princess",
    [ "ST" ]     = "st sunken atal temple",
    [ "BRD" ]    = "brd emperor angerforge",
    [ "DM2" ]    = "dire maul diremaul",
    [ "DME" ]    = "dme dmeast east jumprun",
    ...
    [ "OHF" ]    = "ohf durnholde durnhold hillsbrad",
...
if has_wotlk then
  local wotlkTags = langSplit({
    ["AK"] =  "ahn'kahet old kingdom ak ank",
    ["AN"] =  "azjol nerub azn",
    ["DTK"] =  "drak'tharon draktharon drak dtk",
    ["GUN"] =  "gundrak gun gd gdk",
    ["HOL"] =  "lightning hol",
    ["HOS"] =  "stone hos",
    ["COS"] =  "culling cos",
    ["NEX"] =  "nexus nex nx",
    ["OCU"] =  "oculus ocu oc occ",
    ["VH"] =  "violet hold vh",
    ["UK"] =  "utgarde utk uk",
    ["UP"] =  "pinnacle utp",
    ...
    ["VOA"] =  "vault archavon voa voa10 voa25",
    ["NAX"] = "placeholdernax",
    ...
    ["ONY"] =  "onyxia's ony onyxia",
    ["ICC"] =  "icecrown citadel icc icc25 icc25n icc10 icc10n icc10hc",
    ["RS"] =  "ruby sanctum rs hal hal10 hal25 rs25 rs25n rs10 rs10n rs10hc",
    
    ["WG"]    = "wg wintergrasp",
    ["SOTA"]  = "sota strand ancient",
    ["IOC"] = "ioc conquest isle",
  })
  
  for k, v in pairs(wotlkTags) do
    GBB.dungeonTagsLoc.enGB[k] = v
  end
end
